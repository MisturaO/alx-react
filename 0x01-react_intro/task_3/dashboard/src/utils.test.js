...
describe('getFooterCopy', () => { // describe() function is used to group the test cases for getFooterCopy function.
    it('returns the correct string when the argument is true or false', () => {//The output that shows the test is successful
