    ...
    return (
        <>
            ...
            */}
             ...
             onClick={() => markNotificationAsRead(id)} data-notification-type={type} style={style} >{value}</li> : null}
            {html ? <li data-testid="Mytest" dangerouslySetInnerHTML={{ __html: html }} onClick={() => markNotificationAsRead(id)}>
            </li> : null}
        </>
    );
    }
