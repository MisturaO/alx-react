...
describe('App', () => { //Test suite
    ...
    it('when isLoggedIn is true, verify that the <Login> is not included in DOM, and CourseList component is included', () => {
        ...
        expect(screen.getByText('Login to access the full dashboard')).not.toBeInTheDocument();
    ...
    const displayDrawerElement = screen.getByTestId('display-drawer').__reactInternalInstance;
